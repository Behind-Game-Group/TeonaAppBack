...
public class WalletController {
	...
	@PostMapping("add")
	public ResponseEntity addWallet(@PathVariable Long userId, @RequestBody Wallet wallet, @RequestBody(required=false) Card card,@RequestBody(required=false)  Pass pass) {

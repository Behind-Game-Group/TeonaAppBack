...
//	
//	@Override 
//	public Adess addPass (User user, FormTeonaPass formRequest) {
//		
//		Wallet walletUser = user.getWallet();
//		
//		if( walletUser != null) {
//			Adess pass = new Adess();
...
//	
//	@Override
//	public Adess addTopUp (Long passId, EnumSub topUp) {
//		Optional<Adess> pass = passRepository.findById(passId);
//		Adess passFind = pass.get();
